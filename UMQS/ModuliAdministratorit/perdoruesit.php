			...
			<div id="wrapper">
					...
					<div id="main">
								...
								<ul class="features">
									<li>
										<div class="box">
										<a href="shto_perdorues.php" class="button primary">SHTO PËRDORUES</a>
										<br><br>
									...
									<li>
										<div class="box">
										<a href="modifiko_perdorues.php" class="button primary">MODIFIKO PËRDORUES</a>
										<br><br>
									...
									<li>
										<div class="box">
										<a href="fshije_perdorues.php" class="button primary">FSHIJË PËRDORUES</a>
										<br><br>
										<p>Forma per fshirje te perdoruesve aktual nga uebaplikacion.</p><br>
									</div>
									</li>
								</ul>
