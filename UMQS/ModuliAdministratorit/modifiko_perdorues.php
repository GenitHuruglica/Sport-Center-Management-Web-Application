			...
			<div id="wrapper">
					...
					<div id="main">
							...
							<section id="first" class="main special">
								...
								<div class="box">
								<h2>KERKO TË DHËNAT E PERDORUESIT PËR MODIFIKIM </h2>
...
$p_kon = mysqli_real_escape_string
($lidh,$_REQUEST['p_kon']);     
...
while($rresht = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><b><a href=\"modifiko_p.php?pid=$rresht[pid]\" class='button' class='button primary'>
		Modifiko</a></b></td></tr>";		
	}
